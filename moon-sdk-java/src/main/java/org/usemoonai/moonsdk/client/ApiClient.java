...
import org.usemoonai.moonsdk.client.auth.Authentication;
import org.usemoonai.moonsdk.client.auth.HttpBasicAuth;
import org.usemoonai.moonsdk.client.auth.HttpBearerAuth;
import org.usemoonai.moonsdk.client.auth.ApiKeyAuth;
import org.usemoonai.moonsdk.client.auth.OAuth;
import org.usemoonai.moonsdk.client.auth.RetryingOAuth;
import org.usemoonai.moonsdk.client.auth.OAuthFlow;
...
public class ApiClient {
    ...
    public ApiClient(String basePath, String clientId, String clientSecret, Map<String, String> parameters) {
        ...
        String tokenUrl = "https://vault-api.usemoon.ai/auth/oauth/openai/oauth";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://beta.usemoon.ai
     ...
     * @return a {@link org.usemoonai.moonsdk.client.ApiClient} object
     */
     ...
     * @throws org.usemoonai.moonsdk.client.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws org.usemoonai.moonsdk.client.ApiException If fail to serialize the given object
     */
     ...
     * @throws org.usemoonai.moonsdk.client.ApiException If fail to read file content from response and write to disk
     ...
     * @throws org.usemoonai.moonsdk.client.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws org.usemoonai.moonsdk.client.ApiException If the response has an unsuccessful status code or
     ...
     * @throws org.usemoonai.moonsdk.client.ApiException If fail to serialize the request body object
     */
     ...
     * @param uri URI
     * @throws org.usemoonai.moonsdk.client.ApiException If fails to update the parameters
     */
     ...
     * @throws org.usemoonai.moonsdk.client.ApiException If fail to serialize the request body object into a string
     */
