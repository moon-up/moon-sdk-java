...
public class AccountData {
  ...
  public AccountData keys(List<String> keys) {
    this.keys = keys;
    return this;
  }

  public AccountData addKeysItem(String keysItem) {
    if (this.keys == null) {
  ...
  **/
  ...
  public AccountData address(String address) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.keys, accountData.keys) &&
        Objects.equals(this.address, accountData.address);
  }
