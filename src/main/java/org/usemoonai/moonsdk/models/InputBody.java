...
public class InputBody {
  ...
  **/
  ...
  public InputBody data(String data) {
    this.data = data;
    return this;
  }
  ...
  **/
  ...
  public InputBody input(String input) {
    this.input = input;
    return this;
  }
  ...
  **/
  ...
  public InputBody value(String value) {
    this.value = value;
    return this;
  }
  ...
  **/
  ...
  public InputBody nonce(String nonce) {
    this.nonce = nonce;
    return this;
  }
  ...
  **/
  ...
  public InputBody gas(String gas) {
    this.gas = gas;
    return this;
  }
  ...
  **/
  ...
  public InputBody gasPrice(String gasPrice) {
  ...
  **/
  ...
  public InputBody chainId(String chainId) {
  ...
  **/
  ...
  public InputBody encoding(String encoding) {
  ...
  **/
  ...
  public InputBody EOA(Boolean EOA) {
    this.EOA = EOA;
    return this;
  }
  ...
  **/
  ...
  public InputBody contractAddress(String contractAddress) {
  ...
  **/
  ...
  public InputBody tokenId(String tokenId) {
  ...
  **/
  ...
  public InputBody tokenIds(String tokenIds) {
  ...
  **/
  ...
  public InputBody approved(Boolean approved) {
  ...
  **/
  ...
  public InputBody broadcast(Boolean broadcast) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.to, inputBody.to) &&
        Objects.equals(this.data, inputBody.data) &&
        Objects.equals(this.input, inputBody.input) &&
        Objects.equals(this.value, inputBody.value) &&
        Objects.equals(this.nonce, inputBody.nonce) &&
        Objects.equals(this.gas, inputBody.gas) &&
        Objects.equals(this.gasPrice, inputBody.gasPrice) &&
        Objects.equals(this.chainId, inputBody.chainId) &&
        Objects.equals(this.encoding, inputBody.encoding) &&
        Objects.equals(this.EOA, inputBody.EOA) &&
        Objects.equals(this.contractAddress, inputBody.contractAddress) &&
        Objects.equals(this.tokenId, inputBody.tokenId) &&
        Objects.equals(this.tokenIds, inputBody.tokenIds) &&
        Objects.equals(this.approved, inputBody.approved) &&
        Objects.equals(this.broadcast, inputBody.broadcast);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to InputBody
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InputBody.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InputBody is not found in the empty JSON string", InputBody.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InputBody.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InputBody` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InputBody.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InputBody' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InputBody> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InputBody.class));

       return (TypeAdapter<T>) new TypeAdapter<InputBody>() {
           @Override
           public void write(JsonWriter out, InputBody value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public InputBody read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of InputBody given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of InputBody
  * @throws IOException if the JSON string is invalid with respect to InputBody
  */
  public static InputBody fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InputBody.class);
  }

 /**
  * Convert an instance of InputBody to an JSON string
  *
  * @return JSON string
  */
