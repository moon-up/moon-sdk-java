...
public class Erc20Response {
  ...
  public static final String SERIALIZED_NAME_BALANCE_OF = "balanceOf";
  ...
  public Erc20Response() {
  }

  public Erc20Response type(Double type) {
    this.type = type;
    return this;
  }
  ...
  **/
  ...
  public Erc20Response chainId(Double chainId) {
  ...
  **/
  ...
  public Erc20Response data(String data) {
    this.data = data;
    return this;
  }
  ...
  **/
  ...
  public Erc20Response gas(String gas) {
    this.gas = gas;
    return this;
  }
  ...
  **/
  ...
  public Erc20Response gasPrice(String gasPrice) {
  ...
  **/
  ...
  public Erc20Response gasTipCap(String gasTipCap) {
  ...
  **/
  ...
  public Erc20Response gasFeeCap(String gasFeeCap) {
  ...
  **/
  ...
  public Erc20Response value(String value) {
    this.value = value;
    return this;
  }
  ...
  **/
  ...
  public Erc20Response nonce(Double nonce) {
    this.nonce = nonce;
    return this;
  }
  ...
  **/
  ...
  public Erc20Response from(String from) {
    this.from = from;
    return this;
  }
  ...
  **/
  ...
  public Erc20Response to(String to) {
    this.to = to;
    return this;
  }
  ...
  **/
  ...
  public Erc20Response blobGas(String blobGas) {
  ...
  **/
  ...
  public Erc20Response blobGasFeeCap(String blobGasFeeCap) {
  ...
  **/
  ...
  public Erc20Response blobHashes(List<String> blobHashes) {
    this.blobHashes = blobHashes;
    return this;
  }

  public Erc20Response addBlobHashesItem(String blobHashesItem) {
  ...
  **/
  ...
  public Erc20Response v(String v) {
    this.v = v;
    return this;
  }
  ...
  **/
  ...
  public Erc20Response r(String r) {
    this.r = r;
    return this;
  }
  ...
  **/
  ...
  public Erc20Response s(String s) {
    this.s = s;
    return this;
  }
  ...
  **/
  ...
  public Erc20Response name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public Erc20Response symbol(String symbol) {
    this.symbol = symbol;
    return this;
  }
  ...
  **/
  ...
  public Erc20Response decimals(String decimals) {
  ...
  **/
  ...
  public Erc20Response totalSupply(String totalSupply) {
  ...
  **/
  ...
  public Erc20Response contractAddress(String contractAddress) {
  ...
  **/
  ...
  public Erc20Response balanceOf(String balanceOf) {
  ...
  **/
  ...
  public Erc20Response allowance(String allowance) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    Erc20Response erc20Response = (Erc20Response) o;
    return Objects.equals(this.type, erc20Response.type) &&
        Objects.equals(this.chainId, erc20Response.chainId) &&
        Objects.equals(this.data, erc20Response.data) &&
        Objects.equals(this.gas, erc20Response.gas) &&
        Objects.equals(this.gasPrice, erc20Response.gasPrice) &&
        Objects.equals(this.gasTipCap, erc20Response.gasTipCap) &&
        Objects.equals(this.gasFeeCap, erc20Response.gasFeeCap) &&
        Objects.equals(this.value, erc20Response.value) &&
        Objects.equals(this.nonce, erc20Response.nonce) &&
        Objects.equals(this.from, erc20Response.from) &&
        Objects.equals(this.to, erc20Response.to) &&
        Objects.equals(this.blobGas, erc20Response.blobGas) &&
        Objects.equals(this.blobGasFeeCap, erc20Response.blobGasFeeCap) &&
        Objects.equals(this.blobHashes, erc20Response.blobHashes) &&
        Objects.equals(this.v, erc20Response.v) &&
        Objects.equals(this.r, erc20Response.r) &&
        Objects.equals(this.s, erc20Response.s) &&
        Objects.equals(this.name, erc20Response.name) &&
        Objects.equals(this.symbol, erc20Response.symbol) &&
        Objects.equals(this.decimals, erc20Response.decimals) &&
        Objects.equals(this.totalSupply, erc20Response.totalSupply) &&
        Objects.equals(this.contractAddress, erc20Response.contractAddress) &&
        Objects.equals(this.balanceOf, erc20Response.balanceOf) &&
        Objects.equals(this.allowance, erc20Response.allowance);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(type, chainId, data, gas, gasPrice, gasTipCap, gasFeeCap, value, nonce, from, to, blobGas, blobGasFeeCap, blobHashes, v, r, s, name, symbol, decimals, totalSupply, contractAddress, balanceOf, allowance);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to Erc20Response
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Erc20Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Erc20Response is not found in the empty JSON string", Erc20Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Erc20Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Erc20Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("balanceOf") != null && !jsonObj.get("balanceOf").isJsonNull()) && !jsonObj.get("balanceOf").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `balanceOf` to be a primitive type in the JSON string but got `%s`", jsonObj.get("balanceOf").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Erc20Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Erc20Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Erc20Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Erc20Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Erc20Response>() {
           @Override
           public void write(JsonWriter out, Erc20Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Erc20Response read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of Erc20Response given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Erc20Response
  * @throws IOException if the JSON string is invalid with respect to Erc20Response
  */
  public static Erc20Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Erc20Response.class);
  }

 /**
  * Convert an instance of Erc20Response to an JSON string
  *
  * @return JSON string
  */
